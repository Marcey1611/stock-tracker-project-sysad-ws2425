...
def yolo_detection():
    ...
    rest_models = defaultdict(lambda: AddRequest(None,None,None))
            ...
            if added_objects:
                for added_object in added_objects:
                    if cls_id_history[added_object]:
                        ...
                        manageAddToDatabase(rest_models,added_object,most_frequent_cls_id)

            if removed_objects:
                for removed_object in removed_objects:
                    manageDeleteToDatabase(rest_models,removed_object)
